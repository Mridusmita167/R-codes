#MLR on 50 startup
library(readr)
startup <- read.csv("F:\\excelr\\Assignment\\Multilinear logistic regression\\50_Startups.csv")
View(startup)
...
#here by checking the plots ,46,47,49,50 have more influence on factors
